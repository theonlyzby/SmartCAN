...
// Une petite tache de fond lancée toutes les 15 secondes pour raffraichir les données de puis le serveur
...
{
    //DATAS Pour rendre dynamique la recherche appliquer le même raisonnement que pour la fonction getTempActuelle
...
{
    //DATA Fonction permettant d'envoyer au serveur le fait que la temperature confort est modifiée
	// Pour la démo on ne fait rien, mais mettre ici votre url de type rest pour publier la nouvelle valeur
	//	var requestTempConfort=$.ajax({
...
{
	//DATA Fonction permettant d'envoyer au serveur le fait que la temperature mini est modifiée
	// Pour la démo on ne fait rien, mais mettre ici votre url de type rest pour publier la nouvelle valeur
...
{
// Pour rendre dynamique la recherche appliquer le même raisonnement que pour la fonction getTempActuelle
//DATA Ici on récupère un valeur aléatoire pour la démo, mais sinon en décommentant en  dessous et positionnant votre 
	// url la température sera récupérée en AJAX
	//var requestTempMini=$.ajax({
...
$("#fire").css("opacity","0");
heatNow="";
// Appel a HomeAutomate pour arrêter le mode forcé
