...
INSERT INTO `ha_element_types` (`id`, `Manufacturer`, `subsystem_type`, `role`, `Type`, `Description`) VALUES
(1, 'DomoCAN3', '0x50', 'OUT', '0x11', 'Dimmer'),
(2, 'DomoCAN3', '0x50', 'FUNCTION', '0x16', 'Memory, on GRAD16 card, allow resetting pre-programmed scenarios'),
(3, 'DomoCAN3', '0x51', 'OUT', '0x12', 'ON/OFF'),
(4, 'DomoCAN3', '0x60', 'IN', '0x22', 'Input ON/OFF Switch'),
(5, 'Zwave', '0xA0', 'Thermostat', '0x31', 'Zwave Wall Radiator Thermostat'),
(6, 'Zigbee', '0xA0', 'Thermostat', '0x41', 'Zigbee Wall Radiator Thermostat');
UNLOCK TABLES;
